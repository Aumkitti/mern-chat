...
const Chat = () => {
    ...
    <div className="flex h-screen">
      <div className="bg-white w-1/3 flex flex-col">
        ...
        <div className="p-2 text-center flex items-center justify-center">
          ...
          <button className="text-sm bg-blue-100 py-1 px-2 text-gray-500 border rounded-md hover:bg-red-500 hover:text-black" onClick={logout}>
            Logout
          </button>
        </div>
      </div>
      <div className="flex flex-col bg-gray-200 w-2/3 p-2">
        <div className="flex-grow">
          ...
          {!!selectedUserId && (
            <div className="relative h-full">
              <div className="overflow-y-scoll absolute top-0 left-0 right-0 bottom-0">
                {messageWithoutDups.map(message => (
                  <div 
                    ...
                    (message.sender === id ? "bg-black text-white": "bg-white text-gray-500")}>
        ...
        <form className="flex gap-2 w-auto" onSubmit={sendMessage}>
          <input 
            type="text" 
  ...
  <button type="submit" className="bg-black p-2 text-white rounded-md w-8 hover:bg-white hover:text-black">
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      fill="none" 
      viewBox="0 0 24 24" 
